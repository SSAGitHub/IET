...
setUpHotFolder(baseDir + "/" + "ietTVimportVideoRecordFromIetTvEditingSystem", "IET TV Video Record Ingestion");
setUpHotFolder(baseDir + "/" + "ietTVimportFromInpsec", "IET TV Video Record Inspec Ingestion");
