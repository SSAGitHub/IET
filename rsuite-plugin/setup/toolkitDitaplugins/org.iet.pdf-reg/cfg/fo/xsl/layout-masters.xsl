...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="createDefaultLayoutMasters">
        <fo:layout-master-set>
          ...
          <fo:simple-page-master master-name="body-landscape" page-height="210mm" page-width="297mm">
            <fo:region-body margin-bottom="20mm" margin-left="23mm" margin-right="23mm" margin-top="20mm"/>
            <fo:region-before display-align="before" extent="20mm" region-name="landscape-header"/>
            <fo:region-after display-align="after" extent="20mm" region-name="landscape-footer"/>
          </fo:simple-page-master>
