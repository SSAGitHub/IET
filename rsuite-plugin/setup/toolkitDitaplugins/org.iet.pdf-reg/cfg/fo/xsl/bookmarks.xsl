...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                exclude-result-prefixes="opentopic-index opentopic exslf opentopic-func ot-placeholder mml"
                version="2.0">

    <xsl:variable name="map" select="//opentopic:map"/>

    <xsl:template match="*[contains(@class, ' topic/topic ')][child::*[contains(@class, ' topic/title ')][not(@outputclass = 'empty')]]" mode="bookmark">
