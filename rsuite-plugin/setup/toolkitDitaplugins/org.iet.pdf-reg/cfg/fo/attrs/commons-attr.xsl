...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:attribute-set name="common.border__bottom">
    ...
    <xsl:attribute-set name="common.border__bottom2">
        <xsl:attribute name="border-bottom-style">solid</xsl:attribute>
        <xsl:attribute name="border-bottom-width">1pt</xsl:attribute>
        <xsl:attribute name="border-bottom-color">white</xsl:attribute><!-- SA00 -->
    </xsl:attribute-set>
  ...
  <!-- common element specific attribute sets -->
    ...
    <xsl:attribute-set name="topic.title" use-attribute-sets="common.title">
        <!-- SA00 no border on title -->
		<xsl:attribute name="border-bottom">3pt solid white</xsl:attribute>
        <xsl:attribute name="space-before">0pt</xsl:attribute>
        <xsl:attribute name="space-after">16.8pt</xsl:attribute>
        <!-- SA00 Chapter title reduce font, center text -->
    ...
    <xsl:attribute-set name="topic.topic.title" use-attribute-sets="common.title common.border__bottom2">
        <xsl:attribute name="space-before">0pt</xsl:attribute>
        <xsl:attribute name="space-before">0pt</xsl:attribute>
        <xsl:attribute name="space-after">0pt</xsl:attribute>
        <xsl:attribute name="color">black</xsl:attribute>
        <!-- SA00 Regulation title reduce font -->
