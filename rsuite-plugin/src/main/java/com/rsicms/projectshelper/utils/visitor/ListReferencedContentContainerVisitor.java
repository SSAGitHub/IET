package com.rsicms.projectshelper.utils.visitor;
...
/**
 * Populate lists of all <code>ContentAssembly</code> and <code>ManagedObject</code> instances directly or indirectly referenced by the starting <code>ContentAssemblyNodeContainer</code>.
 */
...
extends TreeDescendingContentAssemblyVisitorBase {
	...
	private final static Log log = LogFactory.getLog(
		ListReferencedContentContainerVisitor.class);
	...
	/**
	 * A complete list of content assemblies that are directly or indirectly referenced by the starting container.
	 * This list does not include CANodes.
	 */
	private List<ContentAssembly> referencedContentAssemblyList;
	
	/**
	 * A complete list of top-level MOs that are directly or indirectly referenced by the starting container.
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.rsicms.rsuite.helpers.tree.impl.TreeDescendingContentAssemblyVisitorBase#visitContentAssemblyNodeContainer(com.reallysi.rsuite.api.ContentAssemblyNodeContainer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.rsicms.rsuite.helpers.tree.impl.DefaultContentAssemblyVisitor#visitManagedObject(com.reallysi.rsuite.api.ManagedObject)
	 */
	@Override
	public void visitManagedObject(
			ManagedObject mo) 
	throws RSuiteException {
	...
	/**
	 * @return A list of <code>ContentAssembly</code> instances directly or indirectly referenced by the starting container.
	 */
	...
	/**
	 * @return A list of <code>ManagedObject</code> instances directory or indirectly referenced by the starting container.
	 */
