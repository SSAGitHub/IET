package com.rsicms.projectshelper.net.http;
...
public class MultipartRequest {
    ...
    public MultipartRequest(String requestURL, String charset) throws IOException {
        this(requestURL, charset, 0);
    }

    public MultipartRequest(String requestURL, String charset, int timeout) throws IOException {
     ...
     * @throws IOException
     */
    public InputStream completeRequest() throws IOException {
