...
import org.theiet.rsuite.journals.domain.issues.publish.finalartilces.IssueFinalArticlesPdfWorkflowLauncher;
 ...
 * 
 */
public class GenerateFinalIssueArticlesPdfWebService extends ProjectRemoteApiHandler {

    private static final String WEB_SERVICE_LABEL = "Generate Issue Final Articles PDF";
	...
	protected String exectuteAction(RemoteApiExecutionContext context,
		...
		IssueFinalArticlesPdfWorkflowLauncher.launchFinalArticlesPdfWorkflowForIssue(context, args, issue);
